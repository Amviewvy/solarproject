...
const MeterComparisonGraph: React.FC<MeterComparisonGraphProps> = ({ field, selectedMeters }) => {
  ...
  return (
    <div className={styles.graphCard}>
      ...
      <ResponsiveContainer width="100%" height={280}>
        <LineChart data={data} margin={{ top: 10, right: 10, left: margin, bottom: 0 }}>
          <CartesianGrid strokeDasharray="3 3" />
          <XAxis dataKey="month" tick={{ fill: '#737373', fontSize, fontFamily: 'DM Sans' }} />
